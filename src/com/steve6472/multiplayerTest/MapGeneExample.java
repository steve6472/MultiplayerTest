...
public class MapGeneExample
{
	...
	public static void makeChangeForAmount(int a_targetChangeAmount) throws Exception
	{
		...
		Map<String, Integer> alleles = new Hashtable<String, Integer>();
		alleles = new Hashtable<String, Integer>();
		...
		System.out.println("For a total of " + MinimizingMakeChangeFitnessFunction.amountOfChange(bestSolutionSoFar) + " cents in "
	...
	public static void main(String[] args) throws Exception
	{
		...
		} else
		{
			...
			{
				System.out.println("The <amount> argument must be between 1 and " + (MinimizingMakeChangeFitnessFunction.MAX_BOUND - 1) + ".");
			} else
			{
